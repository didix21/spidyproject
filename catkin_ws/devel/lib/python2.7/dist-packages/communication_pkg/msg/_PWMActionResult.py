...
"""autogenerated by genpy from communication_pkg/PWMActionResult.msg. Do not edit."""
import sys
...
class PWMActionResult(genpy.Message):
  _md5sum = "ab14756c8ffa41a4f3554adf1e3f8ca3"
  _type = "communication_pkg/PWMActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','communication_pkg/PWMResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PWMActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = communication_pkg.msg.PWMResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = communication_pkg.msg.PWMResult()
