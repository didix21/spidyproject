...
"""autogenerated by genpy from communication_pkg/PWMAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import communication_pkg.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class PWMAction(genpy.Message):
  _md5sum = "aeb275d2386e4bff000368c529a03f92"
  _type = "communication_pkg/PWMAction"
...
"""
  ...
  _slot_types = ['communication_pkg/PWMActionGoal','communication_pkg/PWMActionResult','communication_pkg/PWMActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PWMAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = communication_pkg.msg.PWMActionGoal()
      if self.action_result is None:
        self.action_result = communication_pkg.msg.PWMActionResult()
      if self.action_feedback is None:
        self.action_feedback = communication_pkg.msg.PWMActionFeedback()
    else:
      self.action_goal = communication_pkg.msg.PWMActionGoal()
      self.action_result = communication_pkg.msg.PWMActionResult()
      self.action_feedback = communication_pkg.msg.PWMActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_result.result.result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.pwm = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
